    ...
    ui(new Ui::MainWindowClass)
{
    ...
    connect(ui->avviaKinect, &QPushButton::clicked, this, &MainWindow::on_avviaKinect_clicked);
    connect(ui->startRecordingButton, &QPushButton::clicked, this, &MainWindow::on_startRecordingButton_clicked);
    connect(ui->stopRecordingButton, &QPushButton::clicked, this, &MainWindow::on_stopRecordingButton_clicked);
    connect(ui->pushButtoprocessfileP, &QPushButton::clicked, this, &MainWindow::on_offlineProcess_clicked);
...
void MainWindow::on_avviaKinect_clicked()
{
    if (isCapturing)
    {
...
void MainWindow::sendCommandToServer(const QString& command)
{
...
void MainWindow::on_offlineProcess_clicked()
{
    ...
    if (!file_path.isEmpty())
    {
        ...
        ProcessWorker* p = new ProcessWorker(this);
        p->moveToThread(&workerThread);
        connect(&workerThread, &QThread::finished, p, &QObject::deleteLater);
        connect(this, &MainWindow::operate, p, &ProcessWorker::process_mkv_offline);
        connect(p, &ProcessWorker::resultReady, this, &MainWindow::handleResult);


        emit operate(file_path.toStdString().c_str(), strNewName.toStdString().c_str(), tracker_config);
        
    }
}

void MainWindow::handleResult(bool)
{
    qDebug() << "ciao";
}

void MainWindow::updateUI(k4a::capture& capture)
{
